...
import FlotableInput from '../../components/FlotableInput/index';
import DropDownIcon from '../../assets/svgs/DropDownIcon';
import NotifPageIcon from '../../assets/svgs/NotifPageIcon';

function Withdrawal({navigation, route}) {
  const {
    result,
    setResult,
    expression,
  ...
  const typeOdDeposit = [{name: 'Cash'},{name: 'Bank Transfer'}, {name: 'Credit Card'}, {name: 'ATM'}];
