...
const topFilterBtnData = [
  ...
  {
    lable: locales('titles.deposit'),
    value: 1,
  },
  {
    lable: locales('titles.withdrawal'),
    value: 2,
  },
];

const bottomFilterBtn = [
  {label: locales('titles.cash'), value: 0},
  {label: locales('titles.creditCard'), value: 1},
  {label: locales('titles.atm'), value: 2},
];

function BankFilter({refRBSheet}) {
